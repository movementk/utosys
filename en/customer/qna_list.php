...
<body class="customer">
					...
					<li> 
						<div class="dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="depth-list">
								<a class="dropdown-item" href="/en/customer/notice_list.php">Notice</a>
    ...
    <main id="content" class="qna-list">
    	<div class="container">
				...
				<li>
					<ul>
						...
						<li class="subject lock">
							<a href="/en/customer/qna_view.php">
								임의의 내용을 노출합니다.
							</a>
						</li>
						<li class="user">
			...
			<div class="btn-area">
				<p>
					<a href="/en/customer/qna_write.php" class="btn btn-navy">Writing</a>
				</p>
			</div>
			<nav class="paging">
				<ol class="pagination">
