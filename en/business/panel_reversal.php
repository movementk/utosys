			...
			<div class="row">
				<div class="col-12 col-xl-6">
					<figure>
						...
						<img src="/en/assets/images/business/img_loader_md.jpg" class="img-fluid d-sm-none d-md-block d-xl-none" alt="">
						<img src="/en/assets/images/business/img_loader_xl.jpg" class="img-fluid d-sm-none d-md-none d-xl-block"alt="">
					</figure>
				</div> 
				<div class="col-12 col-xl-6">
